import { summarizeActivities } from "./summarizeActivities";

describe("summarizeActivities()", () => {
    it("should summarize the activity data for each team", () => {
        const activityData = [
            {
              resource_state: 2,
              athlete: {
        ...
        const activities = summarizeActivities(activityData);
